        ...
        <div class="container-fluid mb-3 px-10-dark">
            <div class="mt-4 mb-5 m-2">
                <div class="form-card justify-content-center dark">
                    <div class="card-body">
                        <h3 class="p-1 mt-2 form-label">Edit Order</h3>
                        <form action="{{ route('orders.update', $order) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('order_date') is-invalid @enderror"
                                    name="order_date" id="order_date" value="{{ old('order_date', $order->order_date) }}">
                                @error('order_date')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('amount') is-invalid @enderror"
                                    name="amount" id="amount" value="{{ old('amount', $order->amount) }}">
                                @error('amount')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('salesman_id') is-invalid @enderror"
                                    ...
                                    @foreach ($salesmen as $salesman)
                                        <option value="{{ $salesman->salesman_id }}" {{ old('salesman_id', $order->salesman_id) == $salesman->salesman_id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('customers_id') is-invalid @enderror"
                                    ...
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->customers_id }}" {{ old('customers_id', $order->customers_id) == $customer->customers_id ? 'selected' : '' }}>
