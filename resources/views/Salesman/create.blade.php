        ...
        <div class="container-fluid mb-3 px-10-dark">
            <div class="mt-4 mb-5 m-2">
                <div class="form-card justify-content-center dark">
                    <div class="card-body">
                        <h3 class="p-1 mt-2 form-label">Create Salesman Data</h3>
                        <form action="{{ route('salesmans.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('salesman_name') is-invalid @enderror"
                                    name="salesman_name" id="salesman_name" value="{{ old('salesman_name') }}">
                                @error('salesman_name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('salesman_city') is-invalid @enderror"
                                    name="salesman_city" id="salesman_city" value="{{ old('salesman_city') }}">
                                @error('salesman_city')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control @error('comision') is-invalid @enderror"
                                    name="comision" id="comision" value="{{ old('comision') }}">
                                @error('comision')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
